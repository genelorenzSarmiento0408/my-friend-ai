...
function Footer() {
  return (
    <footer className="flex px-20 py-8 bg-main-1 gap-2 flex-col lg:flex-row ">
      <p className="self-center mr-auto font-extralight">
        Copyright © 2024 MY FRIEND AI | All Rights Reserved{" "}
      </p>
      <div className="self-center flex gap-3">
        <Button className="px-[1rem] py-[0.7rem] rounded-xl bg-main-3 self-center">
          <Image src={FB} alt="Facebook icon" />
        </Button>
        <Button className="px-[0.7rem] py-[0.7rem] rounded-xl bg-main-3 self-center">
